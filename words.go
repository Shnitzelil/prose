...
var enWordList = []string{
	...
	"insect", "rain", "place", "responsible", "sand", "second", "attempt",
	"decision", "leather", "married", "other", "seed", "dear", "building",
	"tall", "value", "with", "disease", "flag", "pump", "by", "front", "collar",
	"join", "advertisement", "fowl", "in", "now", "fat", "wall", "past",
	"morning", "broken", "thick", "bell", "then", "harmony", "knife", "together",
	"fall", "feeling", "print", "street", "day", "have", "expert", "important",
	"woman", "thread", "nose", "screw", "complete", "crush", "carriage", "smoke",
	"till", "clear", "plant", "process", "up", "angle", "transport", "stocking",
	"on", "ear", "will", "bed", "table", "cut", "foolish", "mountain", "motion",
	"substance", "spring", "scissors", "station", "eye", "horse", "boiling",
	"play", "grip", "root", "down", "property", "comparison", "I", "dog",
	"respect", "card", "do", "reading", "normal", "butter", "shut", "delicate",
	"cough", "who", "mass", "example", "sock", "brown", "no", "cup", "minute",
	"seat", "liquid", "smooth", "end", "humour", "discussion", "flame", "before",
	"over", "fact", "shirt", "still", "sneeze", "slow", "free", "request", "church",
	"act", "arm", "tendency", "bee", "foot", "operation", "reward", "agreement",
	"mother", "sound", "secretary", "note", "stage", "tight", "please", "town",
	"yes", "round", "under", "you", "doubt", "new", "lift", "special", "laugh",
	"door", "roof", "narrow", "rough", "turn", "feeble", "far", "nut", "gold",
	"shoe", "wax", "ring", "dirty", "equal", "number", "pencil", "grain", "ship",
	"fertile", "side", "selection", "loss", "say", "ticket", "move", "cruel",
	"mixed", "interest", "though", "glove", "point", "sort", "care", "young",
	"material", "oven", "sugar", "complex", "fire", "small", "separate",
	"son", "crack", "first", "office", "let", "brain", "straight", "argument",
	"line", "slope", "military", "same", "thunder", "baby", "chin", "word",
	"smash", "run", "rice", "bread", "heart", "the", "snake", "skin", "offer",
	"good", "oil", "behaviour", "work", "wave", "angry", "design", "very",
	"credit", "whip", "deep", "chain", "pleasure", "sticky", "wrong", "store",
	"cotton", "destruction", "rod", "glass", "needle", "possible", "red",
	"law", "journey", "black", "camera", "trouble", "peace", "birth", "force",
	"meal", "secret", "conscious", "attraction", "addition", "group", "stem",
	"clean", "thought", "love", "old", "weather", "rule", "page", "desire",
	"bottle", "scale", "river", "tail", "chief", "paint", "east", "grass",
	"medical", "direction", "early", "pocket", "sudden", "future", "be",
	"religion", "muscle", "warm", "dark", "linen", "support", "bit", "box",
	"mind", "take", "female", "opposite", "among", "punishment", "apparatus",
	"development", "produce", "hearing", "male", "coal", "when", "cat",
	"part", "silver", "brick", "long", "branch", "attack", "quiet", "existence",
	"plane", "clock", "out", "person", "boy", "daughter", "chance", "power",
	"wine", "organization",
}
